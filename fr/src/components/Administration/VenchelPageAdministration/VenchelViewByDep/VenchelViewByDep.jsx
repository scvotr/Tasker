...
export const VenchelViewByDep = ({ dep, venchels, reRender }) => {
  ...
  useEffect(() => {
    if (dep === 3) {
      setSelectedButton("dep_ae_1");
    } else if (dep === 4) {
      setSelectedButton("dep_pe_1");
    }
    const sc_1 = venchels.venchels.filter(
      (venchel) => venchel.sector_id === dep_ae_1_ID
    );
    setAaaa((prev) => ({
      ...prev,
      sc_1: sc_1,
    ...
    const sc_2 = venchels.venchels.filter(
      (venchel) => venchel.sector_id === dep_ae_2_ID
    );
    setAaaa((prev) => ({
      ...prev,
      sc_2: sc_2,
    ...
    const sc_3 = venchels.venchels.filter(
      (venchel) => venchel.sector_id === dep_pe_1_ID
    );
    setAaaa((prev) => ({
      ...prev,
      sc_3: sc_3,
    ...
    const sc_4 = venchels.venchels.filter(
      (venchel) => venchel.sector_id === dep_pe_2_ID
    );
    setAaaa((prev) => ({
      ...prev,
      sc_4: sc_4,
    ...
    const sc_5 = venchels.venchels.filter(
      (venchel) => venchel.sector_id === dep_pe_3_ID
    );
    setAaaa((prev) => ({
      ...prev,
      sc_5: sc_5,
    ...
    const sc_6 = venchels.venchels.filter(
      (venchel) => venchel.sector_id === dep_pe_4_ID
    );
    setAaaa((prev) => ({
      ...prev,
      sc_6: sc_6,
